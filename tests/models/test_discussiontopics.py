...
def test_discussiontopics_default_values(unix_timestamp):
    # Create an instance of DiscussionTopics without optional fields
    dashboard = DiscussionTopics(title="Test Dashboard", created_at=unix_timestamp)
