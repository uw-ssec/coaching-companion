...
def test_assessmentssite_default_values(unix_timestamp):
    # Create an instance of AssessmentsSite without optional fields
    dashboard = AssessmentsSite(title="Test Dashboard", created_at=unix_timestamp)
