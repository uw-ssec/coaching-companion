...
def test_studentsubmissions_default_values(unix_timestamp):
    # Create an instance of StudentSubmissions without optional fields
    dashboard = StudentSubmissions(title="Test Dashboard", created_at=unix_timestamp)
