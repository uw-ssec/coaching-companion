...
def test_assessmentsrating_default_values(unix_timestamp):
    # Create an instance of AssessmentsRating without optional fields
    dashboard = AssessmentsRating(title="Test Dashboard", created_at=unix_timestamp)
