...
def test_videohighlightsubmission(unix_timestamp):
    ...
    dashboard = VideoHighlightSubmission(
...
def test_videohighlightsubmission_default_values(unix_timestamp):
    # Create an instance of VideoHighlightSubmission without optional fields
    dashboard = VideoHighlightSubmission(title="Test Dashboard", created_at=unix_timestamp)
