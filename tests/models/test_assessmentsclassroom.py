...
def test_assessmentsclassroom(unix_timestamp):
    ...
    dashboard = AssessmentsClassroom(
...
def test_assessmentsclassroom_default_values(unix_timestamp):
    # Create an instance of AssessmentsClassroom without optional fields
    dashboard = AssessmentsClassroom(title="Test Dashboard", created_at=unix_timestamp)
