...
def test_assessmentslister_default_values(unix_timestamp):
    # Create an instance of AssessmentsLister without optional fields
    dashboard = AssessmentsLister(title="Test Dashboard", created_at=unix_timestamp)
