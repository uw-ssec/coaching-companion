...
def test_familysurveylink_default_values(unix_timestamp):
    # Create an instance of FamilySurveyLink without optional fields
    dashboard = FamilySurveyLink(title="Test Dashboard", created_at=unix_timestamp)
