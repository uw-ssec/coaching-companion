...
def test_videoconference_default_values(unix_timestamp):
    # Create an instance of VideoConference without optional fields
    dashboard = VideoConference(title="Test Dashboard", created_at=unix_timestamp)
