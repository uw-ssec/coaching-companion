...
def test_managestudents_default_values():
    ...
    dashboard = ManageStudents(title="Test Dashboard", created_at=unix_timestamp)
...
def test_managestudents_name_max_length():
    ...
    long_name = "A" * 300
    ManageStudents(title=long_name, created_at=unix_timestamp)
