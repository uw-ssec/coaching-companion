...
def test_recordsreviewsubmission(unix_timestamp):
    ...
    dashboard = RecordsReviewSubmission(
...
def test_recordsreviewsubmission_default_values(unix_timestamp):
    # Create an instance of RecordsReviewSubmission without optional fields
    dashboard = RecordsReviewSubmission(title="Test Dashboard", created_at=unix_timestamp)
