...
def test_recordsreviewhandbook(unix_timestamp):
    ...
    dashboard = RecordsReviewHandbook(
...
def test_recordsreviewhandbook_default_values(unix_timestamp):
    # Create an instance of RecordsReviewHandbook without optional fields
    dashboard = RecordsReviewHandbook(title="Test Dashboard", created_at=unix_timestamp)
