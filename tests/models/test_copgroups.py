...
def test_copgroups(unix_timestamp):
    ...
    dashboard = CopGroups.model_validate(
...
def test_copgroups_default_values():
    # Create an instance of CopGroups without optional fields
    dashboard = CopGroups(title="Test Dashboard")
...
def test_copgroups_name_max_length():
    ...
    with pytest.raises(OverflowError):
        CopGroups.model_validate({"created_at": long_num})
    # Validate the created_at
