...
def test_assessmentsevaluation(unix_timestamp):
    ...
    dashboard = AssessmentsEvaluation(
...
def test_assessmentsevaluation_default_values(unix_timestamp):
    # Create an instance of AssessmentsEvaluation without optional fields
    dashboard = AssessmentsEvaluation(title="Test Dashboard", created_at=unix_timestamp)
