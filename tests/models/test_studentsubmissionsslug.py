...
def test_studentsubmissionsslug(unix_timestamp):
    ...
    dashboard = StudentSubmissionsSlug(
...
def test_studentsubmissionsslug_default_values(unix_timestamp):
    # Create an instance of StudentSubmissionsSlug without optional fields
    dashboard = StudentSubmissionsSlug(title="Test Dashboard", created_at=unix_timestamp)
