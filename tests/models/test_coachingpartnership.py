...
def test_coachingpartnership_default_values(unix_timestamp):
    # Create an instance of CoachingPartnership without optional fields
    dashboard = CoachingPartnership(title="Test Dashboard", created_at=unix_timestamp)
