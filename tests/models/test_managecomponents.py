...
def test_managecomponents_default_values(unix_timestamp):
    # Create an instance of ManageComponents without optional fields
    dashboard = ManageComponents(title="Test Dashboard", created_at=unix_timestamp)
