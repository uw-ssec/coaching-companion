...
def test_instructormaterials_default_values():
    ...
    dashboard = InstructorMaterials(title="Test Dashboard", created_at=unix_timestamp)
...
def test_instructormaterials_name_max_length():
    ...
    long_name = "A" * 300
    InstructorMaterials(title=long_name, created_at=unix_timestamp)
