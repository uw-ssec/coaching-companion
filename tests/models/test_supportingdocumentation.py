...
def test_supportingdocumentation(unix_timestamp):
    ...
    dashboard = SupportingDocumentation(
...
def test_supportingdocumentation_default_values(unix_timestamp):
    # Create an instance of SupportingDocumentation without optional fields
    dashboard = SupportingDocumentation(title="Test Dashboard", created_at=unix_timestamp)
