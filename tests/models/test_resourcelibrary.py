...
def test_resourcelibrary_default_values(unix_timestamp):
    # Create an instance of ResourceLibrary without optional fields
    dashboard = ResourceLibrary(title="Test Dashboard", created_at=unix_timestamp)
