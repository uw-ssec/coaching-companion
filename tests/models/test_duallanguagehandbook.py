...
def test_duallanguagehandbook(unix_timestamp):
    ...
    dashboard = DualLanguageHandbook(
...
def test_duallanguagehandbook_default_values(unix_timestamp):
    # Create an instance of DualLanguageHandbook without optional fields
    dashboard = DualLanguageHandbook(title="Test Dashboard", created_at=unix_timestamp)
