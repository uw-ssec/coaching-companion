...
def test_videoreflection_default_values(unix_timestamp):
    # Create an instance of VideoReflection without optional fields
    dashboard = VideoReflection(title="Test Dashboard", created_at=unix_timestamp)
