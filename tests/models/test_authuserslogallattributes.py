...
def test_authuserslogallattributes():
...
def test_authuserslogallattributes_default_values():
    # Define the datetime string
    datetime_str = "2021-12-01T00:00:00Z"
    # Parse the datetime string into a datetime object
    datetime_obj = datetime.strptime(datetime_str, "%Y-%m-%dT%H:%M:%SZ")
...
def test_authuserslogallattributes_name_max_length():
    ...
    long_name = "A" * 300
    AuthUsersLogAllAttributes(title=long_name, created_at=unix_timestamp)
