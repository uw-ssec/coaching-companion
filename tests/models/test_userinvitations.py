...
def test_userinvitations_default_values(unix_timestamp):
    # Create an instance of UserInvitations without optional fields
    dashboard = UserInvitations(title="Test Dashboard", created_at=unix_timestamp)
