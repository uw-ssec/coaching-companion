...
def test_programprofilesubmission(unix_timestamp):
    ...
    dashboard = ProgramProfileSubmission(
...
def test_programprofilesubmission_default_values(unix_timestamp):
    # Create an instance of ProgramProfileSubmission without optional fields
    dashboard = ProgramProfileSubmission(title="Test Dashboard", created_at=unix_timestamp)
